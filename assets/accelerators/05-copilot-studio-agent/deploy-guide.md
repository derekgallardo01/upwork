...
- Privacy/data-handling configured per **asset 04** (no public-model training,
...
7. **Handover** — document per **asset 03** (handover pack) and walk the client
...
- [ ] Privacy/no-training configuration recorded and signed off (asset 04).
- [ ] Channels published; owner can edit topics.
- [ ] Handover guide + walkthrough delivered (asset 03).
